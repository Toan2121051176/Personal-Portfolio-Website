  ...
  return (
    <div className='bg-black text-white text-center py-16'>
        ...
        <h1 className='text-4xl font-bold'>
            Tôi tên là {" "}
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Toàn Báo</span>
            , Lập trình viên Full-Stack
        </h1>
        <p className='mt-4 text-lg text-gray-300'>
        Tôi chuyên xây dựng các ứng dụng web hiện đại và đáp ứng.        </p>
